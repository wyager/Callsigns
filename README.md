...
To run, run `cat /user/share/dict/web2 | ./Callsigns`. You must have `HS.dat` in the same directory. You can use any dictionary file. The program will also try to use plurals and words with a single letter missing.
